const content = {
    en: {
        ...
        hardSkills: [
            { type: "DevOps", skills: ["Docker", "Docker Compose", "Bash", "Linux", "Virtualization", "Microservices"] },
    ...
    fr: {
        ...
        hardSkills: [
            { type: "DevOps", skills: ["Docker", "Docker Compose", "Bash", "Linux", "Virtualisation", "Microservices"] },
            { type: "Monitoring", skills: ["Grafana", "Prometheus", "ELK Stack"] },
