    ...
    <div className={LayoutStyles.wrapper}>
      ...
      <main>
        <p>
          ...
          opportunités d'améliorations et d'apprentissage, ainsi que de relever
          de nouveaux défis en expérimentant des solutions innovantes.
          <br />
        </p>
        <p>
          Je suis ravie de me présenter en tant que développeuse web et de
          partager ce que je peux offrir dans ce domaine. J'ai pu étudier, lors
          de ma formation chez Openclassrooms, une base solide dans les
          principes de développement web. J'ai pu me familiarisée avec plusieurs
          langages de programmations, notamment Javascript et le framework
          React. Mes compétences dans ces langages, je les ai aiguisés lors des
          divers projets entrepris dans cette formation.
        </p>
        <p>
          Bien que je sois développeuse junior, je suis très motivée et
          désireuse d'apprendre. Je commence tout juste mon parcours dans le
